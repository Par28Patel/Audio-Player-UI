  ...
  // Play the audiobook by setting the audioFile to the current chapter title (from chapterTitles array list) 
	...
	public void printTOC()
	{
		for (int i = 0; i < this.chapterTitles.size(); i ++) {
			System.out.println("Chapter " + (i+1) + ". " + this.chapterTitles.get(i) + "\n");
		}
	}
	...
	{
		// cast the other object as an AudioContent object
		AudioBook otherB = (AudioBook) other;
		
		// compare all other important attributes with the use of superclass method equals()
		return super.equals(otherB) && this.author.equals(otherB.author) && this.narrator.equals(otherB.narrator);
	}
